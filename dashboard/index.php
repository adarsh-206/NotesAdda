...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a href='allfiles/$file' target='_blank' style='color: #dd5;'>View </a></td>";
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="yellow" >** <?php echo $_SESSION['course']; ?> Engineering </font><font color="orange"> notes uploaded by various users **</font></marquee></center>
                        </h3>
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a href='viewprofile.php?name=$file_uploader' target='_blank'> $file_uploader </a></td>";
    echo "<td>$file_date</td>";
    echo "<td><a href='allfiles/$file' target='_blank' style='color: #dd5;'>Download </a></td>";
 echo "</tr>";
